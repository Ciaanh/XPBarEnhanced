...
L["TT_RATE"] = "Rate"
L["TT_NEXT"] = "Next"
L["TT_SHIFT_DRAG_MOVE"] = "Shift+Drag to move"
...
L["TT_OPEN_PROFESSIONS"] = "Right-click: open Professions"
...
L["OPT_CLASSIC_WIDTH"] = "Classic bar width"
L["OPT_CLASSIC_WIDTH_DESC"] = "Width of the Classic bar in pixels. The end caps keep their size while the middle stretches, so the border stays crisp at any width."
