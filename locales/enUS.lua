...
L["OPT_BAR_STYLE_DESC"] = "Choose which XP bar to display: None (Blizzard only), Classic (Blizzard-style), Flat (Draggable), Vertical (Falling animation), Circular (Progress ring), Reputation (Tracked faction), or Segmented (Discrete blocks)."
...
L["OPT_BAR_STYLE_REPUTATION"] = "Reputation (Tracked faction)"
L["OPT_BAR_STYLE_SEGMENTED"] = "Segmented (Discrete blocks)"
