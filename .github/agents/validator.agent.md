...
## Reference Paths
- GlobalAPI.lua, Events.lua, WidgetAPI.lua, etc. are in `${REFS_ROOT}/BlizzardInterfaceResources/Resources/`
- Blizzard source: `${REFS_ROOT}/BlizzardInterfaceCode/Interface/AddOns/`
