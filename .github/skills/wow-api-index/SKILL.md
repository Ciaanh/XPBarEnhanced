...
4. If the skill doesn't exist yet, use WebFetch on `https://warcraft.wiki.gg/wiki/API_<FunctionName>`
5. For raw data verification, consult `wow-blizzard-resources` (KethoDoc searchable data)
6. For Blizzard implementation patterns, consult `wow-blizzard-source` (Blizzard UI source search)
...
| wow-api-midnight-changes | Patch 12.0.0 breaking changes, Secret Values, removed/new APIs | :white_check_mark: |
| wow-blizzard-source | Guide for searching BlizzardInterfaceCode (310 Blizzard addons) | :white_check_mark: |
| wow-blizzard-resources | Guide for searching BlizzardInterfaceResources (KethoDoc data) | :white_check_mark: |
